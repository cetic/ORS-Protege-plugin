...
public class GenerateProtegeOwlJavaCodeAction extends ProtegeOWLAction implements GenerateCodeCallback {
	...
	public static final String NAMESPACE_PREFS_KEY = "namespace";
    ...
    public void initialise() throws Exception {
        ...
        //String namespace=owlOntology.getOntologyID().getDefaultDocumentIRI().get().toString();
        String namespace=PrefixUtilities.getPrefixOWLOntologyFormat(owlModelManager).getDefaultPrefix();
        options.setNamespace(codeGenerationPreferences.getString(NAMESPACE_PREFS_KEY,namespace));
    ...
    private void showGeneratorPanel() {
        ...
        codeGenOptionFrame = new JFrame("Generate Protege-OWL Java Code for ORS");
    ...
    public void okClicked() {
        ...
        //String namespace=owlOntology.getOntologyID().getDefaultDocumentIRI().get().toString();
        String namespace=PrefixUtilities.getPrefixOWLOntologyFormat(owlModelManager).getDefaultPrefix();
        codeGenerationPreferences.putString(NAMESPACE_PREFS_KEY,namespace);//options.getNamespace());
